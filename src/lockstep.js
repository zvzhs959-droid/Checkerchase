...
(function(){
  ...
  class Lockstep {
    constructor(opts){
      ...
      // Prefill initial frames (0..inputDelay-1) with neutral input for all slots.
      // Without this, lockstep would wait forever on frame 0 because the first submitted inputs are frame+inputDelay.
